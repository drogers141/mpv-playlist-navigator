...
--    pl.update()
--    print("on_loaded()")
--    print("media-title:", mp.get_property('media-title'))
--    print("Resolution")
--    for k, v in pairs({"width", "height"}) do
--        print(v, "=>", mp.get_property(v))
--    end
--end
...
--script message handler - pass messages within and between scripts I believe
--function handle_message(msg, value, value2)
--    local vidname = mp.get_property('media-title')
...
--end
--
--mp.register_script_message("playlist_manager", handle_message)
